    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <th scope="row"><img src="inc/des/<?php echo $row['image'] ?>" alt="" width="70"></th>
                <th scope="row">
                    <a href="inc/des/deletecategory.php?id=<?php echo $row['id'] ?>">
                        <button type="submit" name="delete" class="btn btn-danger">
                            delete
                        </button>
                    </a>

                    <a href="inc/des/editcategory.php?id=<?php echo $row['id'] ?>">
...
<a href="inc/des/addcategory.php">
